...
object TermuxScriptProvider {
     ...
     * Version 0.2: Includes non-destructive self-test mode (--self-test).
     */
    ...
    /**
     * Bulletproof Setup & Repair Command for Termux (Version 0.2).
     *
     * Functions both as a first-time installer and a non-destructive repair tool.
     * Features explicit machine-readable stage markers:
     * - TUBEP3_SETUP:STARTING
     * - TUBEP3_SETUP:UPDATING
     * - TUBEP3_SETUP:STORAGE
     * - TUBEP3_SETUP:FFMPEG
     * - TUBEP3_SETUP:YTDLP
     * - TUBEP3_SETUP:BACKEND
     * - TUBEP3_SETUP:EXTERNAL
     * - TUBEP3_SETUP:VERIFYING
     * - TUBEP3_SETUP:READY
     * - TUBEP3_SETUP:FAILED
     */
